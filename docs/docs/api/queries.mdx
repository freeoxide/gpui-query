...
See [Caching](/guides/caching) for details on cache policies and GC behavior. See [Retry](/guides/retry) for retry configuration.
...
See [Caching](/guides/caching) for the full picture.
